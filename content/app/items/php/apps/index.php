              ...
              <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                <div class="card bg-light d-flex flex-fill">
                  ...
                  <div class="card-body pt-0">
                    <div class="row">
                      <div class="col-7">
                        <h2 class="lead"><b>Daniel Salinas</b></h2>
                        ...
                        <ul class="ml-4 mb-0 fa-ul text-muted">
                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address:
                            Buenos Aires, Provincia de Buenos Aires, Argentina </li>
                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: </li>
                        </ul>
                      </div>
                      <div class="col-5 text-center">
                        <img src="../img/danicode.jpg" alt="user-avatar" class="img-circle img-fluid">
                      </div>
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="text-right">
                      <a href="https://www.youtube.com/@Dani-Code" class="btn btn-sm bg-light" target="_blank">
                        <span class="text-danger h4"><i class="bi bi-youtube"></i></span>
                      </a>
                      <a href="./autores/danicode/danicode.php" class="btn btn-sm btn-primary" target="_blank">
                        <i class="bi bi-file-earmark-code-fill"></i> Ver Apps
                      </a>
                    </div>
                  </div>
                </div>
