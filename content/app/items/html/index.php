    ...
    <div>
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-primary">HTML</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title"><strong>Qué es HTML</strong></h5>
                  <p class="card-text">
                  </p>
                  <a href="https://html.spec.whatwg.org/multipage/" class="card-link" target="_blank">HTML Oficial</a>
                  <a href="https://www.w3.org/Style/CSS/Overview.en.html" class="card-link" target="_blank">CSS
                    Oficial</a>
                  <a href="/content/app/items/html/apps/index.php" class="card-link" target="_blank">Ir a Apps</a>
                </div>
              </div>
