...
<title>Tailwind | Aplicaciones</title>
<?php 
  //include "../../../templates_nivel_0/nav-ini.php";
  //include "../templates/nav-tailwind.php";
 ?>
  ...
  <div class="container mt-5">
    <div class="card-group mb-5 m-auto">
      <div class="row m-auto g-3">
        <!-- Aprendible: Curso Práctico de Tailwind CSS -->
        <div class="col col-sm-12 col-md-6 col-lg-4 col-xl-3 card shadow-sm" style="max-width: 22rem;">
          <img src="./assets/img/tailwind_1hora.webp" alt="tailwind 1 hora" width="100%" height="225" role="img">
          <div class="card-body">
            <h3 class="card-text">Aprendible: Curso Práctico de Tailwind CSS | Aprende en 1 hora</h3>
            <p class="card-text">Proyecto de Iniciación de Tailwind CSS</p>
          </div>
          <div class="card-footer d-flex justify-content-around align-items-center">
            <a type="button" class="btn btn-sm btn-primary" href="./aprendible/index.html">Ir a
              la app</a>
            <a type="button" class="btn btn-sm p-0" href="https://www.youtube.com/watch?v=vwNklJxbsw0&t=371s&ab_channel=Aprendible" target="_blank" style="font-size: 40px;"><i class="bi bi-youtube text-danger"></i></a>
          </div>
        ...
        <div class="col col-sm-12 col-md-6 col-lg-4 col-xl-3 card shadow-sm" style="max-width: 22rem;">
          ...
          <div class="card-footer d-flex justify-content-around align-items-center">
            <a type="button" class="btn btn-sm btn-primary" href="apps/cod-de-programacion/crud-modal/app/peliculas/index.php" target="_blank">Ir a
              la App</a>
            <a type="button" class="btn btn-sm p-0" href="apps/src/videos/cod_prog_video_crud_modal.php" target="_blank" style="font-size: 40px;"><i class="bi bi-youtube text-danger"></i></a>
          </div>
        </div>
