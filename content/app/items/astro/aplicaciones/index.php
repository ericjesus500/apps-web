...
<title>ASTRO | Aplicaciones</title>
</head>
                ...
                <div class="card-group mb-5 m-auto">
                    <div class="row m-auto g-3">
                        ...
                        <div class="col col-sm-12 col-md-6 col-lg-4 col-xl-3 card shadow-sm" style="max-width: 22rem;">
                            ...
                            <div class="card-footer d-flex justify-content-around align-items-center">
                                <a type="button" class="btn btn-sm btn-primary"
                                    href="apps/develoteca-sitio-web/index.php">Ir a
                                    la app</a>
                                <a type="button" class="btn btn-sm p-0"
                                    ...
                                    target="_blank" style="font-size: 40px;"><i
                        ...
                        <div class="col col-sm-12 col-md-6 col-lg-4 col-xl-3 card shadow-sm" style="max-width: 22rem;">
                            ...
                            <div class="card-footer d-flex justify-content-around align-items-center">
                                <a type="button" class="btn btn-sm btn-primary"
                                    href="apps/develoteca-app-alumnos/index.php" target="_blank">Ir a la App</a>
                                <a type="button" class="btn btn-sm p-0"
                        ...
                        <div class="col col-sm-12 col-md-6 col-lg-4 col-xl-3 card shadow-sm" style="max-width: 22rem;">
                            <img src="./assets/img/cod_de_programacion.jpg" alt="php" width="100%" height="225"
                                role="img">
                            <div class="card-body">
                            ...
                            <div class="card-footer d-flex justify-content-around align-items-center">
                                <a type="button" class="btn btn-sm btn-primary"
                                    href="apps/cod-de-programacion/crud-modal/app/peliculas/index.php"
                                    target="_blank">Ir a
                                    la App</a>
                                <a type="button" class="btn btn-sm p-0"
                                    href="https://www.youtube.com/watch?v=ghbWKVlJ3X8&t=705s" target="_blank"
                        ...
                        <div class="col col-sm-12 col-md-6 col-lg-4 col-xl-3 card shadow-sm" style="max-width: 22rem;">
                            <img src="./assets/img/mejaalex.jpg" alt="crup php sin recargar" width="100%" height="225"
                                role="img">
                            <div class="card-body">
                            ...
                            <div class="card-footer d-flex justify-content-around align-items-center">
                                <a type="button" class="btn btn-sm btn-primary"
                                    href="apps/mejaalex/crud_sin_recargar/app/index.php" target="_blank">Ir a la
                                    App</a>
                                <a type="button" class="btn btn-sm p-0"
                                    href="https://www.youtube.com/watch?v=EONkg6T2rVw" target="_blank"
                                    style="font-size: 40px;"><i class="bi bi-youtube text-danger"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col col-sm-12 col-md-6 col-lg-4 col-xl-3 card shadow-sm" style="max-width: 22rem;">
                            ...
                            <div class="card-footer d-flex justify-content-around align-items-center">
                                <a type="button" class="btn btn-sm btn-primary" href="" target="_blank">Ir a
                                    la App</a>
                                <a type="button" class="btn btn-sm p-0" href="" target="_blank"
                                    style="font-size: 40px;"><i class="bi bi-youtube text-danger"></i></a>
                            </div>
                        </div>
                    </div>
