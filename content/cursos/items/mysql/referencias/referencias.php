  ...
  <div class="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="row m-auto w-100">
        <?php include_once "../templates/navbar-mysql-full.php"; ?>
      </div>
                ...
                <section>
                  <div class="card">
                    ...
                    <div class="card-footer bg-primary">
                      Vea el tema en la página oficial de MYSQL
                    </div>
                  </div>
                </section>
              </div>
      ...
      <aside class="control-sidebar control-sidebar-primary bg-light" style="display: none; height: 70vh;">
        ...
        <div class="p-3">
          ...
          <li class="nav-item d-flex flex-column">
            <div class="dropdown-divider"></div>
            <a href="/content/cursos/items/mysql/cheatsheets/mysql_cheat_sheet.pdf" class="" target="_blank">
              <i class="fa-solid fa-code ms-3"></i> Cheat sheet
            </a>
            <a href="/content/cursos/items/mysql/cheatsheets/mysql_cheat_sheet.md" class="">
              <i class="fa-solid fa-code ms-3"></i> Cheat sheet
            </a>
            <!-- <a href="#" class="">
