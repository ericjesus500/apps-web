          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title"><strong>Qué es Mysql</strong></h5>
                  <p class="card-text">
                  ...
                  <a href="#" class="card-link" target="_blank">Laravel Oficial</a>
                  <a href="http://codigos/items/laravel/index.php" class="card-link" target="_blank">Mi
                    Tutorial</a>
              ...
              <div class="card card-primary card-outline">
                <div class="card-body">
                  <h5 class="card-title"><strong>Sección Informatica acerca de Laravel</strong></h5>
                  <p class="card-text">
                    Resumen de Guías diversas acerca de Laravel.
                  </p>
                  <a href="/content/cursos/items/laravel/guias/guias.php" class="card-link">Ir a resumen </a>
            ...
            <div class="col-lg-6">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-warning collapsed-card" style="transition: all 0.15s ease 0s; height: inherit; width: inherit;">
                  <div class="card-header">
                    <h3 class="card-title">Más sobre Laravel</h3>
              ...
              <!-- El Ecosistema de Laravel en 2023 -->
              <div class="card card-warning card-outline">
                <div class="card-header">
                ...
                <div class="card-body">
                  ...
                  <a href="/content/cursos/items/laravel/articulos/articulo_autor.php" class="btn btn-warning" target="_blank">Ver el artículo completo</a>
                </div>
              </div>
              <div class="card">
                <div class="card-header">
