  ...
  <div class="wrapper w-100 m-auto">
    ...
    <div class="container-fluid">
      ...
      <div class="row m-auto w-100">
        <?php include_once "../templates/navbar-react-full.php"; ?>
      </div>
                ...
                <section>
                  <div class="card">
                    ...
                    <div class="card-footer bg-primary">
                      Vea el tema en la página oficial de NODE
                    </div>
                  </div>
                </section>
              </div>
      ...
      <aside class="control-sidebar control-sidebar-primary bg-light" style="display: none; height: 70vh;">
        ...
        <div class="p-3">
          ...
          <li class="nav-item d-flex flex-column">
            ...
            <a href="https://transform.tools/html-to-jsx" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Convertir HTML a JSX
            </a>
            <a href="https://mui.com/core/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Componentes gratis
            </a>
            ...
            <a href="https://www.material-tailwind.com/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Componentes CSS Tailwind
            </a>
            <a href="https://ant.design/docs/react/introduce/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Biblioteca React UI
            </a>
            <a href="https://v2.chakra-ui.com/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Biblioteca Chakra UI
            </a>
            <a href="https://www.radix-ui.com/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Radix UI
            </a>
            <a href="https://ui.shadcn.com/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Shadcn UI
            </a>
            <a href="https://motion.dev/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Motion
            </a>
