...
<title>PYTHON | Referencias</title>
</head>
  ...
  <div class="wrapper w-100 m-auto">
    ...
    <div class="container-fluid">
      ...
      <div class="row m-auto w-100 ">
        <?php include_once "../templates/navbar-python-full.php"; ?>
      </div>
                ...
                <section>
                  <div class="card">
                    ...
                    <div class="card-footer bg-primary">
                      Vea el tema en la página oficial de Python
                    </div>
                  </div>
                </section>
              </div>
        ...
        <div class="p-3">
          ...
          <li class="nav-item d-flex flex-column">
            <a href="#" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Tuto 1
            </a>
            <a href="#" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Tuto 2
            </a>
            <a href="#" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Tuto 3
            </a>
          </li>
