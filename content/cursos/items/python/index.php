      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <img src="/src/img/python.jpg" class="card-img-top" alt="astro">
                <div class="card-body">
            ...
            <div class="col-lg-6">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-warning collapsed-card" style="transition: all 0.15s ease 0s; height: inherit; width: inherit;">
                  ...
                  <div class="card-body">
                    <p>Ver más <a class="btn-link" href="./articulos/articulos.php" target="_blank">artículos</a> sobre Python</p>
                  </div>
                </div>
              </div>
