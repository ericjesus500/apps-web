...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="container-fluid">
      ...
      <!-- Control Sidebar -->
      <aside class="control-sidebar control-sidebar-primary bg-dark" style="display: none; height: 70vh;">
        ...
        <div class="p-3">
          ...
          <li class="nav-item d-flex flex-column">
            ...
            <a href="#" class="">
              <i class="fa-solid fa-check-to-slot ms-3"></i> 4 new messages
            </a>
            <a href="#" class="">
              <i class="fa-solid fa-check-to-slot ms-3"></i> 8 friend requests
            </a>
            <a href="#" class="">
              <i class="fa-solid fa-check-to-slot ms-3"></i> 3 new reports
            </a>
          </li>
          <div class="dropdown-divider"></div>
          ...
          <li class="nav-item d-flex flex-column">
            <div class="dropdown-divider"></div>
            <a href="/assets/AdminLTE-3.2.0/index.html" class="text-white" target="_blank">
              <i class="fa-regular fa-compass ms-3"></i> Vali Admin
            </a>
            <a href="http://codigos/assets/adminlte320/index.html" class="text-white" target="_blank">
            ...
            <a href="https://html5up.net/" class="text-white" target="_blank">
