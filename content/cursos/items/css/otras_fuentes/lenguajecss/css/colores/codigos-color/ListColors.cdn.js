...
const DARK_COLORS = [
  ...
  "darkmagenta", "purple", "mediumblue", "blue", "rebeccapurple", "blueviolet", "darkorchid", "brown", "firebrick"
];
...
class ListColors extends HTMLElement {
  ...
  showColors() {
    ...
    colors.forEach(color => {
      ...
      div.innerHTML = `<span>${color}</span><data>${rgb}</data>`;
