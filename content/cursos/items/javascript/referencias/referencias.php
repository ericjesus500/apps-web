  ...
  <div class="wrapper w-100 m-auto">
    ...
    <div class="container-fluid">
      ...
      <div class="row m-auto w-100">
        <?php include_once "../templates/navbar-js-full.php"; ?>
      </div>
      ...
      <div class="row pb-3 w-100 m-auto">
        <div class="col-md-12 col-sm-12 w-100 d-flex ps-3">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input check-nivel" type="radio" name="flexRadioDefault" id="inlineRadio4" value="datatable">
            <label class="form-check-label" for="inlineRadio4">DataTable</label>
          </div>
        </div>
      </div>
      ...
      <div class="m-auto" style="min-height: 361px;">
        ...
        <div class="content">
          <div class="container-fluid">
                ...
                <section>
                  <div class="card">
                    ...
                    <div class="card-footer bg-primary">
                      Vea el tema en la página oficial de Javascript
                    </div>
                  </div>
                </section>
              </div>
            ...
            <!--DataTable-->
            <div id="datatable" class="row m-auto p-0 d-none">
              <div class="col-sm-12 col-md-12">
                <section>
                  <div class="card">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-8">
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-1-tab">Item 1</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-2-tab">Instalación2</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-3-tab">Item 3</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-4-tab">Item 4</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-5-tab">Item 5</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-6-tab">Item 6</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-7-tab">Item 7</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-8-tab">Item 8</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-9-tab">Item 9</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-datatable-10-tab">Item 10</a>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="card-footer bg-success">
                      Vea el tema en la página oficial de Datatable
                    </div>
                  </div>
                </section>
              </div>
      ...
      <aside class="control-sidebar control-sidebar-primary bg-light" style="display: none; height: 90vh;">
        ...
        <div class="p-3">
          ...
          <ul class="m-0 p-0">
            ...
            <li class="nav-item d-flex flex-column">
              <a href="/content/cursos/otras_fuentes/javascript/lenguajejs.com/javascript/index.htm" target="_blank">
                <i class="fa-solid fa-check-to-slot ms-3"></i> LenguajeJS.com
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="/content/cursos/otras_fuentes/javascript/es.javascript.info/index.htm" target="_blank">
                <i class="fa-solid fa-check-to-slot ms-3"></i>Javascript Info
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="/content/cursos/otras_fuentes/javascript/pdfs/eloquent.pdf" target="_blank">
                <i class="fa-solid fa-file-pdf ms-3"></i> Eloquent JS PDF
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="/content/cursos/otras_fuentes/javascript/pdfs/javascript-es.7.pdf" target="_blank">
                <i class="fa-solid fa-file-pdf ms-3"></i>Javascript-es PDF
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="/content/cursos/otras_fuentes/javascript/curso-ddesign/ddesing-2019.html" target="_blank">
                <i class="fa-solid fa-check-to-slot ms-3"></i> JS Moderno 2019
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="/content/cursos/otras_fuentes/javascript/curso-ddesign/manual_dd-2019.html" target="_blank">
          ...
          <ul class="m-0 p-0">
            <li class="nav-item d-flex flex-column">
              <div class="dropdown-divider"></div>
              <a href="/assets/vali-admin-master-2023/docs/dashboard.html" target="_blank">
          ...
          <ul class="m-0 p-0">
            ...
            <li class="nav-item d-flex flex-column">
              <a href="https://sweetalert2.github.io/" target="_blank">
                <i class="fa-solid fa-table-list ms-3"></i>Sweetalert 2
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="https://jquery.com/" target="_blank">
                <i class="fa-solid fa-table-list ms-3"></i>jQuery
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="https://d3js.org/" target="_blank">
                <i class="fa-solid fa-table-list ms-3"></i>D3.js
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="https://underscorejs.org/" target="_blank">
                <i class="fa-solid fa-table-list ms-3"></i>Underscore JS
              </a>
            </li>
            <li class="nav-item d-flex flex-column">
              <a href="https://animejs.com/" target="_blank">
                <i class="fa-solid fa-table-list ms-3"></i>Anime JS
              </a>
            </li>
          </ul>
          <div class="dropdown-divider"></div>
