...
<body>
  <div class="container mt-5 mx-auto w-75">
    <h1 class="text-center text-primary">USO DE <span class="subtitulo">PDOStatement::bindParam()</span></h1>
    <h2 style="color:brown;">uso con variables</h2>
...
<?php
    ...
    if ($_POST) {
      ...
      if ($nombre != "" && $apellido != "" && $email !="") {
        ...
        include_once "./bindparam.php";

        $data = new AgregarData;
        $data->newData1($nombre, $apellido, $email); 
