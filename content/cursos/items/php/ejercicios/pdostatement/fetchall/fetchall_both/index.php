<?php include_once "./fetchall_both.php" ?>
<!DOCTYPE html>
<html lang="es">
...
<body>
  <div class="container mt-5 mx-auto w-75">
    <h1 class="text-center text-primary my-5">USO DE <span class="subtitulo">PDOStatement::fetchAll()</span></h1>
    <?php
    $obj = new ShowData;
    $data = $obj->verData();
    ?>
