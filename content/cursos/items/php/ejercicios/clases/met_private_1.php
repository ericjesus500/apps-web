<?php 
  ...
  Class Persona {    
    ...
    public function getProfesion1(){
      return $this->setProfesion($this->profesion);
    }

    public function getProfesion2(){
      return $this->profesion;
    }
  }  
...
<body>
  <h1 class="text-center text-primary mt-4">Método Private 1</h1>
  <div class="print w-50 m-auto my-5 border rounded p-3">
    ...
    echo "<p class='fs-5'> <span class='text-primary'>&#36;objInstanciado</span> <span class='text-tomato'>-></span> <span class='text-lila'>nombre_metodo_publico()</span></p>";
      ...
      echo "Profesion1: " . $objInstanciado->getProfesion1();
      echo "<br>";
      echo "Profesion2: " . $objInstanciado->getProfesion2();
    ?>
  </div>
</body>
