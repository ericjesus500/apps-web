  ...
  <div class="wrapper w-100 m-auto">
    ...
    <div class="container-fluid">
      ...
      <div class="row m-auto w-100 ">
        <?php include_once "../templates/navbar-php-full.php"; ?>
      </div>
      ...
      <div class="row pb-3 m-auto w-100">
        <div class="col-md-12 col-sm-12 w-100 d-flex ps-3">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input check-nivel" type="radio" name="flexRadioDefault" id="inlineRadio4" value="server">
            <label class="form-check-label" for="inlineRadio4">Server</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input check-nivel" type="radio" name="flexRadioDefault" id="inlineRadio5" value="composer">
            <label class="form-check-label" for="inlineRadio5">Composer</label>
          </div>
        </div>
      </div>
      ...
      <div class="m-auto" style="min-height: 361px;">
        ...
        <div class="content">
          <div class="container-fluid">
                ...
                <section>
                  <div class="card">
                    ...
                    <div class="card-footer bg-primary">
                      Vea el tema en la página oficial de PHP
                    </div>
                  </div>
                </section>
              </div>
            ...
            <!-- server -->
            <div id="server" class="row m-auto p-0 d-none">
              <div class="col-sm-12 col-md-12">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-8">
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                  <a class="dropdown-item" href="#vert-tabs-item-server-1-tab">Item 1</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-2-tab">Item 2</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-3-tab">Item 3</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-4-tab">Item 4</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-5-tab">Item 5</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-6-tab">Item 6</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-7-tab">Item 7</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-8-tab">Item 8</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-9-tab">Item 9</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-server-10-tab">Item 10</a>
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <!-- composer -->
            <div id="composer" class="row m-auto p-0 d-none">
              <div class="col-sm-12 col-md-12">
                <section class="content">
                  <div class="card">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-8">
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-1-tab">Item 1</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-2-tab">Item 2</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-3-tab">Item 3</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-4-tab">Item 4</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-5-tab">Item 5</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-6-tab">Item 6</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-7-tab">Item 7</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-8-tab">Item 8</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-9-tab">Item 9</a>
                                  <a class="dropdown-item" href="#vert-tabs-item-composer-10-tab">Item 10</a>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="card-footer bg-success">
                      Vea el tema en la página oficial de composer
                    </div>
                  </div>
                </section>
              </div>
      ...
      <!-- Control Sidebar -->
      <aside class="control-sidebar control-sidebar-primary bg-light" style="display: none; height: 90vh;">
        <!-- Control sidebar content goes here -->
        <div class="p-3">
          <h5>Tutoriales Online</h5>
          <li class="nav-item d-flex flex-column">
            <a href="https://programadorwebvalencia.com/cursos/php/base/" target="_blank">
          ...
          <h5>Dashboard</h5>
          <li class="nav-item d-flex flex-column">
            <a href="/assets/vali-admin-master-2023/docs/dashboard.html" class="" target="_blank">
              <i class="fa-regular fa-compass ms-3"></i> Vali Admin
            </a>
            <a href="/assets/adminlte320/index.html" class="" target="_blank">
          ...
          <li class="nav-item d-flex flex-column">
            ...
            <a href="https://github.com/PHPMailer/PHPMailer" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> PHP Mailer
            </a>
            <a href="https://phpspreadsheet.readthedocs.io/en/latest/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> PHP Spread Sheet
            </a>
            <a href="https://tom-select.js.org/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Tom Select
            </a>
            <a href="https://www.mockaroo.com/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Mockaroo
            </a>
            <a href="https://sample-videos.com/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Sample Videos
            </a>
            <a href="https://filamentphp.com/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Filament PHP
            </a>
            <a href="https://docs.flightphp.com/es/v3/" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Flight PHP Framework
            </a>
            <!-- <a href="" target="_blank">
              <i class="fa-solid fa-check-to-slot ms-3"></i> Cheat sheet
            </a> -->
          </li>
          <div class="dropdown-divider"></div>
          <li class="nav-item d-flex flex-column">
            <a href="/content/cursos/articulos/html_css/codigos_ascii.html" target="_blank">
              <i class="fa-solid fa-table-list ms-3"></i>Cod. ASCII
            </a>
          </li>
          <li class="nav-item d-flex flex-column">
            <a href="/content/cursos/articulos/html_css/codigos_html.html" target="_blank">
