            ...
            <div class="col-lg-6">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="http://codigos/items/astro/index.php" class="card-link" target="_blank">Mi
                    Tutorial</a>
                  <a href="/content/app/items/astro/apps/index.php" class="card-link" target="_blank">Ir a Apps</a>
                </div>
              </div>
              <div class="card card-primary card-outline">
                <div class="card-body">
                  <h5 class="card-title"><strong>Sección Informatica acerca de Astro</strong></h5>
                  <p class="card-text">
                    Resumen de Guías diversas acerca de Astro.
                  </p>
                  <a href="/content/cursos/items/astro/guias/guias.php" class="card-link">Ir a resumen </a>
            ...
            <div class="col-lg-6">
              ...
              <div class="card card-warning card-outline">
                ...
                <div class="card-body">
                  ...
                  <a href="/content/cursos/items/astro/articulos/articulo_autor.php" class="btn btn-warning" target="_blank">Ver el artículo completo</a>
                </div>
              </div>
              <div class="card">
                <div class="card-header">
