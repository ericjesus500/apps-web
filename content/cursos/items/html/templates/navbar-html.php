  ...
  <nav class="navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">      
      <li class="nav-item d-sm-inline-block">
        <a href="https://html.spec.whatwg.org/multipage/" class="nav-link" target="_blank">HTML oficial</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/content/cursos/items/html/referencias/referencias.php" class="nav-link">Referencias</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/content/cursos/items/html/apps/guias/guias.php" class="nav-link">Guias</a>
      </li>
      ...
      <li class="nav-item d-sm-inline-block">
        <a href="/content/cursos/items/html/ejercicios/ejercicios.php" class="nav-link" target="_blank">Ejercicios</a>
      </li>
      <li class="nav-item d-sm-inline-block">
        <div class="btn-group">
          ...
          <div class="dropdown-menu" role="menu">
            ...
            <a class="dropdown-item" href="/content/cursos/items/html/otras_fuentes/tutorialesweb/lenguajehtml/html/index.htm" target="_blank">LenguajeHTML.com</a>
          </div>
        </div>
      </li>
    </ul>
