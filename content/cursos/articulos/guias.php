...
$query = "SELECT guia_id, guia_titulo, guia_href, guia_href_local, autor.autor_nombre as autor 
FROM guia 
INNER JOIN autor
...
while ($row = mysqli_fetch_array($result)) {
  ...
  $url = "/content/cursos/items/javascript/articulos/";  
?>
...
<body>
  <div class="container mt-3">
    <div class="row">
      <h1 class="text-center">GUIAS DE JAVASCRIPT</h1>
    </div>
    <div class="row">
      <div class="col-md-12 my-3 d-flex flex-row-reverse">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
          <i class="bi bi-plus-circle-fill me-2 text-white"></i>Nuevo
        </button>
      </div>
    </div>
    <div class="row">
