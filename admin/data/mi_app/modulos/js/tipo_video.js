...
function totalListTipoVideo() {
  ...
  objXHR.open(
    "GET",
    "/admin/data/mi_app/acciones/tipo_video/get_tipo_video.php",
    true
  );
  objXHR.send();
...
function seleccionarRegistro(filaID){
  ...
  let XHR = new XMLHttpRequest();
  XHR.open("POST", "/admin/data/mi_app/acciones/tipo_video/get_id_tipo_video.php")
...
function eliminarRegistro(filaID){
  let XHR = new XMLHttpRequest();
  XHR.open("POST", "/admin/data/mi_app/acciones/tipo_video/eliminaTipoVideo.php")
  XHR.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  XHR.send(`tipo_video_id=${filaID}`);
  XHR.onreadystatechange = function(){
    let rpta = XHR.responseText;
