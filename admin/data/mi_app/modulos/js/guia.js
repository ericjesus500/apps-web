...
function dataCategorias() {
  ...
  xhrGuiaCateg.open("GET", "/admin/data/mi_app/acciones/tecnologia/get_tecnologia.php");
  xhrGuiaCateg.send();
...
function dataAutor() {
  ...
  xhrGuiaAutor.open("GET", "/admin/data/mi_app/acciones/autor/get_autor.php");
  xhrGuiaAutor.send();
...
function getListGuias() {
  ...
  objXHR.open("GET", "/admin/data/mi_app/acciones/guia/get_guia.php", true);
  objXHR.send();
...
function seleccionarRegistro(filaID) {
  ...
  XHR.open(
    "POST",
    "/admin/data/mi_app/acciones/guia/get_data_id_guia.php"
  );
...
function eliminarRegistro(filaID) {
  ...
  XHR.open(
    "POST",
    "/admin/data/mi_app/acciones/guia/eliminaGuia.php"
  );
  XHR.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  XHR.send(`guia_id=${filaID}`);
  XHR.onreadystatechange = function () {
