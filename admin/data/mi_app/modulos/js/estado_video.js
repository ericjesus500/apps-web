...
function totalListEstadoVideo() {
  ...
  objXHR.open(
    "GET",
    "/admin/data/mi_app/acciones/estado_video/get_estado_video.php",
    true
  );
  objXHR.send();
...
function seleccionarRegistro(filaID) {
  ...
  let XHR = new XMLHttpRequest();
  XHR.open("POST", "/admin/data/mi_app/acciones/estado_video/get_id_estado.php");
...
function eliminarRegistro(filaID) {
  let XHR = new XMLHttpRequest();
  XHR.open("POST", "/admin/data/mi_app/acciones/estado_video/eliminaEstadoVideo.php");
  XHR.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  XHR.send(`estado_id=${filaID}`);
  XHR.onreadystatechange = function () {
    let rpta = XHR.responseText;
