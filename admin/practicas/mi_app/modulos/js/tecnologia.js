...
function totalListTecno() {
  ...
  objXHR.open("GET", "/admin/practicas/mi_app/acciones/tecnologia/get_tecnologia.php", true);
  objXHR.send();
...
function seleccionarRegistro(filaID){
  ...
  let XHR = new XMLHttpRequest();
  XHR.open("POST", "/admin/practicas/mi_app/acciones/tecnologia/get_data_id_tecno.php")
...
function eliminarRegistro(filaID){
  let XHR = new XMLHttpRequest();
  XHR.open("POST", "/admin/practicas/mi_app/acciones/tecnologia/eliminaTecno.php")
  XHR.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  XHR.send(`tecno_id=${filaID}`);
  XHR.onreadystatechange = function(){
    let rpta = XHR.responseText;
...
function getRegistro(rptJSON) {
  ...
  const URL_IMG = "/admin/practicas/mi_app/acciones/tecnologia/logos/";
