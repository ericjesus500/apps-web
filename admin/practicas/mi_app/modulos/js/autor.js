...
function getDataAutor(pagina) {
  ...
  let url = "/admin/practicas/mi_app/acciones/autor/paginador.php";
...
buscador.addEventListener('keyup', () => {  
  if (buscador.value!="") {
    ...
    request.open(
      "POST",
      "/admin/practicas/mi_app/acciones/autor/buscaDatosAutor.php",
      true
    );
...
function seleccionarRegistro(filaID){
  ...
  XHR.open(
    "POST",
    "/admin/practicas/mi_app/acciones/autor/get_data_id_autor.php"
  );
...
function eliminarRegistro(filaID) {
  ...
  XHR.open(
    "POST",
    "/admin/practicas/mi_app/acciones/autor/eliminaAutor.php"
  );
  XHR.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function getRegistro(rptJSON) {
  ...
  const URL_IMG = "/admin/practicas/mi_app/acciones/autor/img_autores/";
