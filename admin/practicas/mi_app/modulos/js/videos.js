...
function getDataVideoFull(){
  ...
  let xhr = new XMLHttpRequest();
  xhr.open("GET", "/admin/practicas/mi_app/acciones/videos/get_data_full.php", true)
  xhr.send()
  xhr.onreadystatechange = function(){
...
function getDataVideo(pagina) {
  ...
  let url = "/admin/practicas/mi_app/acciones/videos/paginador.php";
...
buscador.addEventListener("keyup", () => {
  if (buscador.value != "") {
    ...
    request.open(
      "POST",
      "/admin/practicas/mi_app/acciones/videos/buscaDatosVideos.php",
      true
    );
...
function seleccionarRegistro(filaID) {
  ...
  XHR.open(
    "POST",
    "/admin/practicas/mi_app/acciones/videos/get_data_id_video.php"
  );
...
function eliminarRegistro(filaID) {
  let XHR = new XMLHttpRequest();
  XHR.open("POST", "/admin/practicas/mi_app/acciones/videos/eliminaVideo.php");
  XHR.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
  XHR.send(`video_id=${filaID}`);
  XHR.onreadystatechange = function () {
    let rpta = XHR.responseText;
